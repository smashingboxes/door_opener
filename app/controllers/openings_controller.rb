class OpeningsController < ApplicationController
  ...
  def create
    ...
    @opening.file_name = Time.now.strftime("%Y-%m-%d_%H-%M-%S-%p") + ".mp4"
    system("ffmpeg -f video4linux2 -s 320x240 -t 10 -i /dev/video0 -vcodec libx264 -preset slow -crf 22 -threads 0 /home/sb/media/openings/#{@opening.file_name}")
    respond_to do |format|
      if @opening.save
